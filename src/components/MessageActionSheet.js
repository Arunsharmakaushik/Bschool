...
import {getClient} from '../utils/ChatCleintService';
      ...
      options={options.map((option, i) => {
        return (
          <View
            ...
            <Image style={{height:25,width:25,alignSelf:'center' }} source={Images.pin} />
  ...
  return (
    <View style={styles.reactionListContainer}>
      ...
      <TouchableOpacity
        ...
        <Image style={{height:25,width:25,alignSelf:'center' }} source={Images.emoji} />
      </TouchableOpacity>
    </View>
  );
};
