...
import { ChannelContext, AutoCompleteInput, EmojiPicker, MessageInput } from 'stream-chat-react-native';
...
const GiphyIcon = () => (
  <div className='giphy-icon__wrapper'>
    {/* <LightningBoltSmall /> */}
    <Image style={{height:20,width:20,backgroundColor:'pink'}}/>
...
const MessagingInput = (props) => {
  ...
  const messageInput = MessageInput({ ...props, overrideSubmitHandler });
  ...
  return (
    <div className='str-chat__messaging-input'>
      ...
      >
        {/* <EmojiIcon /> */}
        <Image source={Images.emoji} style={{backgroundColor:'red'}} />
      </div>
      {/* <div
        className="messaging-input__button"
        role="button"
      ...
      <div className='messaging-input__button' role='button' aria-roledescription='button' onClick={messageInput.handleSubmit}>
        {/* <SendIcon /> */}
        <Image source={Images.send} style={{backgroundColor:'yellow'}}/>
      </div>
