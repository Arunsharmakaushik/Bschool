...
{/* <TouchableOpacity style={{ height: hp('4%'), width: wp('10%'), margin: 10, backgroundColor: 'green' }}>
<Text>bjgjhgjhgjhg</Text>
</TouchableOpacity> */}
              ...
              <View style={[styles.container]}>
                {showSectionTitles && (
                  <View style={{ flexDirection: 'row',width:wp(100), }}>
                    ...
                    {/* <TouchableOpacity onPress={() => onCancel()} style={{ height: hp('2%'), alignSelf: 'center', width: '10%',marginLeft:5, marginRight: 10, backgroundColor: 'green' }}>
                      <Image style={{ height: hp('3.2%'), width: hp('3.2%'), position: 'absolute', marginTop: -15, alignSelf: 'center' }} source={Images.cancelIcon} />
                    </TouchableOpacity> */}

<TouchableOpacity onPress={() => onCancel()} style={{ height: hp('4%'), width: hp('4%'),  alignSelf: 'center', }}>
                      <Image resizeMode='contain' style={{alignSelf: 'center',height: hp('4%'), width: hp('4%'),  }} source={Images.cross} />
                    </TouchableOpacity>
