...
export default () => {
  ...
  //   return {
    //   'loadingIndicator.loadingText': `color: ${colors.text}`,
      ...
      // 'messageInput.container': `backgroundColor: white; margin: 0; border-radius: 0;`,
      // 'messageInput.sendButtonIcon': 'height: 25; width: 25; color: black',
  ...
  // }, [colors]);
let chatStyle={'messageInput.container': `backgroundColor: white; margin: 0; border-radius: 0;`,
'messageInput.sendButtonIcon': 'height: 25; width: 25; color: black',
// message: {
//   content: {
//     markdown: {
